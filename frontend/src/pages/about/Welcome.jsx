        ...
        <div className={classes.welcomeNote} style={inlineStyles.welcomeNote}>
          ...
          <div className={classes.intro} style={inlineStyles.intro}>
            <p style={{ marginTop: tabletUp && 0 }}>
              We are dedicated to bringing <strong>fresh farm produce</strong>{" "}
              to your door step. We are just an <strong>order</strong> away from
              you.
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum
              quae eveniet natus rem. Delectus ad vel cumque ducimus quibusdam
              ea necessitatibus corporis laboriosam, perspiciatis facilis
              molestias at tenetur quia quo!
            </p>
            <p>
